/**************************************************************************
 *                                                                        *
 *  File:        TestEditPlaylistState.cs                                 *
 *  Copyright:   (c) 2023, Rareș-Andrei Dancău                            *
 *  Description: Clasa ce testeaza EditPlaylistState                      *
 *                                                                        *
...
{
    /// <summary>
    /// Clasa ce testeaza EditPlaylistState
    /// </summary>
    [TestClass]
    public class TestEditPlaylistState:ITestState
    {
        /// <summary>
        ...
        /// <summary>
        /// Testam daca starea contextului este EditPlaylistState, si ar trebui sa fie
        /// </summary>
        [TestMethod]
        public void TestEditPlaylist()
        {
            _context.Request();
            Assert.AreEqual(true, typeof(EditPlaylistState) == _context.State.GetType());
        }
    }
}

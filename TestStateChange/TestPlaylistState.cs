/**************************************************************************
 *                                                                        *
 *  File:        TestPlaylistState.cs                                     *
 *  Copyright:   (c) 2023, Rareș-Andrei Dancău                            *
 *  Description: Clasa ce testeaza PlaylistState                          *
 *                                                                        *
...
{
    /// <summary>
    /// Clasa ce testeaza PlaylistState
    /// </summary>
    [TestClass]
    public class TestPlaylistState : ITestState
    {
        /// <summary>
        ...
        /// <summary>
        /// Testam daca starea contextului este PlaylistState, si ar trebui sa fie
        /// </summary>
        [TestMethod]
        public void TestPlaylist()
        {
            _context.Request();
            Assert.AreEqual(true, typeof(PlaylistState) == _context.State.GetType());
        }
        /// <summary>

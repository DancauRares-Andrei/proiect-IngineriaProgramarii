/**************************************************************************
 *                                                                        *
 *  File:        TestMakePlaylistState.cs                                 *
 *  Copyright:   (c) 2023, Rareș-Andrei Dancău                            *
 *  Description: Clasa ce testeaza MakePlaylistState                      *
 *                                                                        *
...
{
    /// <summary>
    /// Clasa ce testeaza MakePlaylistState
    /// </summary>
    [TestClass]
    public class TestMakePlaylistState : ITestState
    {
        /// <summary>
        ...
        /// <summary>
        /// Testam daca starea contextului este MakePlaylistState, si ar trebui sa fie
        /// </summary>
        [TestMethod]
        public void TestMakePlaylist()
        {
            _context.Request();
            Assert.AreEqual(true, typeof(MakePlaylistState) == _context.State.GetType());
        }
        /// <summary>
